exports.up = (knex, Promise) => Promise.all([
  ...
  knex.schema.createTableIfNotExists('tournaments', (table) => {
    table.increments();
  ...
  knex.schema.createTableIfNotExists('tournaments_users', (table) => {
  ...
  knex.schema.createTableIfNotExists('bugs', (table) => {
    table.increments();
  ...
  knex.schema.createTableIfNotExists('club_debt', (table) => {
