  ...
  render() {
    ...
    const tournamentTableRows = [
      ...
      tournament.speakerprice
        ? ['Price Speaker', <Currency quantity={tournament.speakerprice || 0} currency="EUR" />] : null,
      tournament.judgeprice
        ? ['Price Judge', <Currency quantity={tournament.judgeprice || 0} currency="EUR" />] : null,
        ...
        <div className="collapseTournamentContainer">
          ...
          <div className="d-flex mt-4">
            ...
            <button type="button" className="btn btn-danger btn-lg ml-auto registerButton"
                    onClick={() => { TournamentRowCollapse.handleClickRegister(tournament.id); }}>
              Register
            </button>
          </div>
        </div>
